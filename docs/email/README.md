...
No paid service, plan upgrade, new authentication route or actual email send is included. Owner-only Access and production usage limits remain in force. Preview screenshots are browser renders, not evidence of Gmail/Outlook delivery or rendering compatibility.
