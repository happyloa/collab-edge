/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 2829ca177ea674f0bd5206660daf8ff0)
// Runtime types generated with workerd@1.20260918.1 2026-09-21 nodejs_compat
interface __BaseEnv_Env {
	...
	BOARD_ROOMS: DurableObjectNamespace<import("./worker/index").BoardRoom>;
	AUTH_LIMITER: DurableObjectNamespace<import("./worker/index").AuthRateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "BoardRoom" | "AuthRateLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ATTACHMENTS_ENABLED" | "REGISTRATION_ENABLED" | "ACCESS_REQUIRED" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "ACCESS_ALLOWED_EMAIL" | "SESSION_SECRET">> {}
}
