...
export const zh = {
  ...
  'Watch real two-browser test': '觀看真實雙瀏覽器測試',
  'Recorded local collaboration': '本機即時協作實錄',
  'Two independent browser sessions use the real local Worker and database. This recording is not a live connection to the public playground or production.':
    '兩個獨立瀏覽器連線到真實的本機 Worker 與資料庫。影片是預錄內容，並非公開展示頁或正式站的即時連線。',
  'Play both recordings': '同時播放兩段影片',
  'Alice browser': 'Alice 的瀏覽器',
  'Bob browser': 'Bob 的瀏覽器',
  'Download video': '下載影片',
  ...
  'Loading activity…': '正在載入活動紀錄…',
  'Load older activity': '載入更早的活動',
  'Loading older activity…': '正在載入更早的活動…',
  'Retry activity': '重試載入活動',
