...
尚未提供密碼重設、應用程式帳號信箱驗證、帳號刪除、擁有權轉移、自動清理孤立附件與事件壓縮。富文字共同編輯、看板範本、通知、游標同步及組織管理是未來方向。Vinext 仍為 beta，升級前需驗證相容性。
